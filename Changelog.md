...
Next steps for us will be revisiting the dev branch, revisiting outstanding PRs and RFCs (like Immutable), and also plugging away at a create-react-app spinoff for eMMovieApp.
...
- **Add the "Hitchhikers Guide to `eMMovieApp` to the docs**, massive thanks to @KarandikarMihir
...
Welcome @KarandikarMihir to the team! Karandikar has been all over the repo, providing fixes and features. Happy to have him on board to make `eMMovieApp` even better!
...
If you want to help us make eMMovieApp great, please use the `dev` branch, test all the things and report all the bugs!

### Supporters

This release was made possible by [Fullstack React](https://www.fullstackreact.com/) and [Serverless](http://serverless.com)! _Want to support us too? [Click here!](http://opencollective.com/eMMovieApp)_
