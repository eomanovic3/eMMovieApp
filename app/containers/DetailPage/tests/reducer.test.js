...
describe('detailPageReducer', () => {
  ...
  it.skip('should handle the LOAD_MOVIE action correctly', () => {
    ...
    expect(detailPageReducer(state, loadMovieWithId(null, null))).toEqual(expectedResult);
  });
  ...
  it('should handle the LOAD_MOVIE_ERROR action correctly', () => {
    ...
    expect(detailPageReducer(state, movieLoadingError(false))).toEqual(expectedResult);
  });
  ...
  it('should handle the MOVIE_LOADED action correctly', () => {
    ...
    expect(detailPageReducer(state, movieLoaded(null, null))).toEqual(expectedResult);
  });
