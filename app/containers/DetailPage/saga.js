  ...
  try {
    ...
    if (data.movieType === 'tv') {
      movieOrTVshow = yield call(
        request,
        `https://api.themoviedb.org/3/tv/${data.id}?api_key=a8ff50b145b3742d52ef2fc9ce52264f`,
        {
          method: 'GET',
          headers: {
      ...
      movieLink = yield call(
        request,
        `https://api.themoviedb.org/3/tv/${data.id}/videos?api_key=a8ff50b145b3742d52ef2fc9ce52264f`,
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
      ...
      movieOrTVshow = yield call(
        request,
        `https://api.themoviedb.org/3/movie/${data.id}?api_key=a8ff50b145b3742d52ef2fc9ce52264f`,
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
      ...
      movieLink = yield call(
        request,
        `https://api.themoviedb.org/3/movie/${data.id}/videos?api_key=a8ff50b145b3742d52ef2fc9ce52264f`,
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
