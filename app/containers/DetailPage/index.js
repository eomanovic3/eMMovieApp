...
class DetailPage extends React.PureComponent {
    ...
    render() {
        ...
        const movieLinkValue = !this.props.movieLink || this.props.movieLink === ''
            ? "https://www.youtube.com/watch?v=vFPajU-d-Ek" : this.props.movieLink;
        if(this.props.movie) {
            return (
                <div className="d-flex flex-column">
                    ...
                    <div className="p-5 d-flex justify-content-center">
                        <div className="flex-column w-75">
                            ...
                            <h2>
                                {this.props.movie.original_title ? this.props.movie.original_title :
                                        (this.props.movie.name ? this.props.movie.name : 'No title')}
